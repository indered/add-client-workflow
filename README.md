...
**Production URL:**  
https://add-client-workflow.vercel.app
...
- Mock auth uses email plus OTP, with no backend check yet.
...
- Use OTP `000000`.
- Example: `advisor@waterlily.com` and `000000`.
